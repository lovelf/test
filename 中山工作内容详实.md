...
- 对接结算费接口
- 增加两个接口 发货成功接口和失败接口
- 发货成功接口 api/v2/order/success


### <span id="2016-07-06">2016-07-06</span> 雨一直下
- 祸福所依 都是机会 机遇，唯有不变的是自己需要不断地学习。
- 祸兮福之所倚，福兮祸之所伏
- 安危相易，祸福相生
- 分销预订单（DistributionBookingOrder）和 分销单（DistributionOrder），billingObjectCode， 

### <span id="2016-07-07">2016-07-07</span> 天晴 温度上升
- 修改product API接口
- 对接product add接口
- 去掉model必须
- product_description必须
- 修改product_price/product_image/product_to_warehouse/
- product 产品
- product_price
- product_image
...
### 测试路径
- 只采用共享 （是否到分销池查货，是否自动买货）
- 只采用预订单 
- 预订单不足的
- 扣费 确认 取消扣费


### <span id="2016-07-08">2016-07-08</span> 天晴 高温
- 今日准备返深
- 